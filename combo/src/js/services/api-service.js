...
class ApiService {
  constructor() {
    ...
    const promoCampaignId = '1400002+2200001';
    const tariffsPath = `.tele2.ru/api/shop/products/devices/bundles/?siteId=${siteId}&category=smartphones&promoCampaignId=${promoCampaignId}&bundleIndex=1&bundleSize=500`;
